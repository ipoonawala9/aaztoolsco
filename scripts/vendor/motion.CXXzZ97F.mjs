...
function pn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(ru(t, r, i, m && au.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && d.push(h);
  }
  if (o) {
  ...
  let [r, i, a] = Tn(e, n),
    o = (e) => {
      ...
      let a = t(r, e),
        ...
        c = (e) => {
          s(e, r === T || r === document || n.useGlobalTarget || Ou(r, e.target));
        },
        l = (e) => {
          s(e, !1);
        };
  ...
  return (
    ...
    () => {
      (Bu.delete(e),
        !Bu.size &&
          typeof Vu == `function` &&
          (T.removeEventListener(`resize`, Vu), (Vu = void 0)));
    }
  );
}
function Vn(e, t) {
...
function da(e) {
  let { initial: t, animate: r } = ua(e, n(df));
...
function _a(e, t, n, r) {
  let i = v(() => {
    let n = hf();
    return (Pr(n, t, vd(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function $a(e) {
  let [t, r] = Zi(),
    i = n(As);
  return b(Lf, { ...e, layoutGroup: i, switchLayoutGroup: n(pf), isPresent: t, safeToRemove: r });
}
function eo(e, t, n) {
  let { props: r } = e;
...
function ko(e, t) {
  return T === void 0 ? !1 : e ? Al() && !!bo(t) : kl();
}
...
function vs(e, { root: t, margin: n, amount: r, once: a = !1, initial: o = !1 } = {}) {
  let [s, l] = i(o);
  return (
    c(() => {
...
function xs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  let s = M(() => Xf[t]),
    u = [],
    d = l(!1),
    f = l(null),
  ...
  return b(s, {
    ...
    ref: m,
    ignoreStrict: !0,
    children: b(Dp.Provider, { value: p, children: e }),
  });
}
function Ss(e, t) {
...
function Ds(e, t, n, r) {
  ...
  let i = Ts(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Es(t - (n === `x` ? T.scrollX : T.scrollY), i, n);
  if (o === null) {
  ...
  return b(u, {
    ...
    onDrag: (e, t) => {
      let { velocity: n, point: i } = t,
        o = f[m].get();
      (g(r, o, n[m]), Ds(_.current, i[m], m, n[m]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (Cs(), o && o(e, t));
    },
...
var As,
  ...
  Ip = t(() => {
    (o(),
      ...
      (Dl = (e) => e.startsWith(`--`)),
      (Ol = {}),
      (kl = It(() => T.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Al = It(() => T.ViewTimeline !== void 0, `viewTimeline`)),
      (jl = It(() => {
        try {
      ...
      (Gd = (e) => d !== void 0 && d.userAgent && d.userAgent.toLowerCase().includes(e)),
      ...
      (Xd = xi({
        ...
        defaultParent: () => {
          if (!Yd.current) {
            let e = new qd({});
            (e.mount(T), e.setOptions({ layoutScroll: !0 }), (Yd.current = e));
          }
          return Yd.current;
        },
        resetTransform: (e, t) => {
      ...
      (Qd = ({
        ...
        return (
          ...
          b(Ns.Provider, { value: _, children: e })
        );
      }),
      ($d = (e) => e.key || ``),
      (ef = ({
      ...
      (af = ({ children: e, id: t, inherit: r = !0 }) => {
        ...
        c.current === null &&
          (rf(r) && u && (t = t ? u + `-` + t : u),
          (c.current = { id: t, group: (nf(r) && i.group) || Gi() }));
        let d = v(() => ({ ...c.current, forceRender: o }), [s]);
        return b(As.Provider, { value: d, children: e });
      }),
      (of = a({ strict: !1 })),
      (sf = {
        animation: [
    ...
    ((df = a({})),
      ...
      (Tf = (e, t) => Math.abs(e - t)),
      (Ef = (e, t) => ((t.isSVG ?? va(e)) ? new yd(t) : new fd(t, { allowProjection: e !== u }))),
      ...
      (lp = new WeakMap()),
      (up = new WeakMap()),
      (dp = (e) => (e === document.scrollingElement ? T : e)),
      (fp = [
        [ip.Enter, `entry`],
        [ip.Exit, `exit`],
        [ip.Any, `cover`],
...
//# sourceMappingURL=motion.CXXzZ97F.mjs.map
