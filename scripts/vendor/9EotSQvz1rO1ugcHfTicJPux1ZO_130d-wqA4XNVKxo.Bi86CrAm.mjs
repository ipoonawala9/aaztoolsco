...
function r(e, n) {
  return {
    breakpoints: [
      ...
      { hash: `9dte0x`, mediaQuery: `(min-width: 810px) and (max-width: 1199.98px)` },
      { hash: `d4bslr`, mediaQuery: `(max-width: 809.98px)` },
    ],
    description: t(e, n).description,
    elements: {},
    robots: `max-image-preview:large`,
    serializationId: `framer-TNRDN`,
...
//# sourceMappingURL=9EotSQvz1rO1ugcHfTicJPux1ZO_130d-wqA4XNVKxo.Bi86CrAm.mjs.map
