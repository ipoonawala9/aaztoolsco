...
function r(e, n) {
  return {
    breakpoints: [
      { hash: `snr130`, mediaQuery: `(min-width: 1200px)` },
      { hash: `u4f453`, mediaQuery: `(min-width: 810px) and (max-width: 1199.98px)` },
      { hash: `4lr372`, mediaQuery: `(max-width: 809.98px)` },
    ],
    description: t(e, n).description,
    elements: {},
    robots: `max-image-preview:large`,
    serializationId: `framer-y0lsX`,
    title: t(e, n).title || `Washer`,
...
//# sourceMappingURL=hL4O5qGb1DMO6wadt02tGRVMtmF_9fe1vL5wKCsu7CY.BqVcNQlN.mjs.map
